...
export function TaskDetail({ taskId, occurrenceDate: occurrenceDateProp }: TaskDetailProps) {
    // Use the new hook for recurrence logic
    const {
        isVirtual,
        realTaskId,
    ...
    } = useTaskRecurrenceLogic({ taskId, occurrenceDateProp })
    ...
    // Recurrence Edit (for Description and Date/Time) -> Managed by hook
    ...
    const occurrence = occurrenceDateStr
    ...
    // handleRecurrenceUpdateConfirm is imported from hook
    ...
    // handleDetachInstance is imported from hook
